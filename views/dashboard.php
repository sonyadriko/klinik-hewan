                                    ...
                                    <div class="card-body">
                                        <div class="invite-content">
                                            ...
                                            <p>
                                                ...
                                                Deposit 3. Finish Trading Tasks <br /><a href="#">Learn more</a>
                                            </p>
                                            ...
                                            <div class="copy-link">
                                                <form action="#">
                                                    <div class="input-group">
                                                        ...
                                                        <span onclick="copy()"
                                                            class="input-group-text c-pointer">Copy</span>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <ul class="balance-widget trade-balance">
                                            ...
                                            <li>
                                                ...
                                                <div class="text-end">
                                                    <h5>$0.0000</h5>
                                                    <span>Trade balance combined with unrealized
                                                        profit/loss</span>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <div class="text-end">
                                                    <h5>$0.0000</h5>
                                                    <span>Usable margin balance. Equal to equity
                                                        minus.</span>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <table class="table table-striped responsive-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>January 15</td>
                                                        <td>
                                                            <span class="danger-arrow"><i
                                                                    class="icofont-arrow-down"></i> Sell</span>
                                                        </td>
                                                        <td class="coin-name">
