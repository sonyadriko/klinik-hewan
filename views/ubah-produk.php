    ...
    if (!empty($_FILES["foto_produk"]["name"])) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["foto_produk"]["tmp_name"], $target_file)) {
                ...
                $query = "UPDATE produk SET nama_produk='$nama_produk', harga_produk='$harga_produk', foto_produk='$foto_produk' WHERE id_produk='$id_produk'";
                if (mysqli_query($conn, $query)) {
                    $alertMessage = "Data produk berhasil diubah.";
                    $alertType = "success";
                } else {
        ...
        // If no file was uploaded, just update the other details
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="number" class="form-control" id="harga_produk" name="harga_produk"
                                            ...
                                            value="<?php echo $product['harga_produk']; ?>" required>
                                    </div>
                                    <div class="form-group mb-4">
